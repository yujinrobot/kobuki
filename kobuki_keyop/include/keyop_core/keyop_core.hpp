...
#include <std_msgs/Float64.h> // for tilt angle commands
...
private:
	...
	ros::Publisher velocity_publisher, rumble_publisher, kinect_tilt_angle_publisher;
	...
	double tilt_angle_step_, tilt_angle_min_, tilt_angle_max_;
	std_msgs::Float64 tilt_angle_;
	std::string name;
	std::string mode_;
	...
	**********************/
	...
	void resetVelocity();
        void incrementTiltAngle();
        void decrementTiltAngle();
