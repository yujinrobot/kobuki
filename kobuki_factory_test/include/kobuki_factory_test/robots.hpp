...
//      os << ",SN,DCJ,MOP,DST,VER,FW,HW,DOCK,BRU,S-Brush,,VAC,PSD,,,FIR,,,DIR,,,Forward,,Backward,,PE,,HALL,DOCK,CHR,G-Test,RESULT";
      os << "SN,VER,,,JACK,DOCK,CHR,PSD,,,BUMP,,,IR-DOCK,,,W-DROP,,MOTOR,,IMU,,BUTTON,,,LED,,SND,RESULT\n";
      os << ",SW,FW,HW,,,,Left,Center,Right,Left,Center,Right,Left,Center,Right,Left,Right,Left,Right,,Diff,F0,F1,F2,1,2,,\n";
    }
