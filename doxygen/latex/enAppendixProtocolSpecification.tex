...
\-Unsigned \-Byte&8-\/bit unsigned integer&1&8&0$\sim$255&unsigned char&uint8\-\_\-t \\\cline{1-7}
\-Unsigned \-Short&16-\/bit unsigned integer&2&16&0$\sim$65,535&unsigned short&uint16\-\_\-t \\\cline{1-7}
\-Unsigned \-Int&32-\/bit unsigned integer&4&32&0$\sim$4,294,967,295&unsigned int&uint32\-\_\-t  \\\cline{1-7}
\end{TabularC}


\par
\subsection{\-Serialization-\/\-Deserialization}\label{enAppendixProtocolSpecification_enSerializationDerialization}
{\tt \-Serialization} is the process of converting a data structure into a bytestream. \-Deserialization is reversal process. \-Each data types are serialized and deserialized by `{\tt \-L\-S\-B}-\/\-First \-Order`. \-It means \-Least \-Significant \-Bytes will comes first on the bytestream. \-For example, \-The integer number 2,864,434,397(0x\-A\-A\-B\-B\-C\-C\-D\-D) can be serialized into\-: \begin{TabularC}{4}
\hline
...
13&\-Set \-Controller \-Gain&\-Set \-P\-I\-D gain of wheel velocity controller \\\cline{1-3}
14&\-Get \-Controller \-Gain&\-Request current \-P\-I\-D gain of wheel velocity controller \\\cline{1-3}
\end{TabularC}


\par
\subsection{\-Base Control}\label{enAppendixProtocolSpecification_enBaseControl}
\-Control wheel motors to moving robot. \-Robot will follow the arc line, which radius is {\bfseries $<$\-Radius$>$} mm, with {\bfseries $<$\-Speed$>$} mm/s. \-Positive \-Radius indicates center of arc line that robot follows is located at the left side of the robot. \-Negative is opposite.\par
...
\begin{TabularC}{3}
\hline
\-Motion&\-Speed(mm/s)&\-Radius(mm) \\\cline{1-3}
\-Pure \-Translation&\-Speed&0 \\\cline{1-3}
\-Pure \-Rotation&w{\bfseries $^{\mbox{i)}}$ } $\ast$ b{\bfseries $^{\mbox{ii)}}$ } / 2&1 \\\cline{1-3}
\multirow{2}{\linewidth}{\-Translation + \-Rotation}&\-Speed $\ast$ ( \-Radius + b{\bfseries $^{\mbox{ii)}}$ } / 2 ) / \-Radius, if \-Radius $>$ 1\par
\-Speed $\ast$ ( \-Radius -\/ b{\bfseries $^{\mbox{ii)}}$ } / 2 ) / \-Radius, if \-Radius $<$ -\/1&\-Radius \\\cline{2-3}
\end{TabularC}
{\bfseries i)} w is rotation speed of the robot, in [rad/s].\par
 {\bfseries ii)} b is {\itshape bias\/} or {\itshape wheelbase\/}, that indicates the length between the center of the wheels. \-Fixed at 230 mm.\par
 \par
...
&\-Duration&1&&&\-Duration of playing note in milli-\/seconds \\\cline{1-6}
\end{TabularC}
...
\-Request extra data from robot. \-Especially version info of kobuki; \-Hardware \-Version, \-Firmware \-Version and \-Unique \-Device \-I\-Dentifier(\-U\-D\-I\-D)
...
\-Data&\-Request flags&2&&&\-Set the flags to request extra data\par
...
0x0040 for external power 12\-V/5\-A ch.\par
0x0080 for external power 12\-V/1.\-5\-A ch.\par
\par
...
\par
\subsection{\-Set Controller Gain}\label{enAppendixProtocolSpecification_enSetControllerGain}
\-Set \-P\-I\-D gain of wheel velocity controller of robot.

\begin{TabularC}{6}
\hline
&\-Name&\-Size&\-Value&\-Value in \-Hex&\-Description \\\cline{1-6}
\-Header&\-Identifier&1&1&0x01&\-Fixed \\\cline{1-6}
\-Length&\-Size of data field&1&13&0x0\-D&\-Fixed \\\cline{1-6}
\multirow{4}{\linewidth}{\-Data}&\-Type&1&&&0 for factory-\/default \-P\-I\-D gain\par
1 for user-\/configured \-P\-I\-D gain \\\cline{1-2}\cline{4-6}
&\-P gain&4&&&\-Kp $\ast$ 1000 (default\-: 100$\ast$1000) \\\cline{1-1}\cline{3-6}
&\-I gain&4&&&\-Ki $\ast$ 1000 (default\-: 0.\-1$\ast$1000) \\\cline{2-6}
&\-D gain&4&&&\-Kd $\ast$ 1000 (default\-: 2$\ast$1000) \\\cline{1-6}
\end{TabularC}


\par
\subsection{\-Get Controller Gain}\label{enAppendixProtocolSpecification_enGetControllerGain}
\-Request \-P\-I\-D gain of wheel velocity controller of robot.

\begin{TabularC}{6}
\hline
&\-Name&\-Size&\-Value&\-Value in \-Hex&\-Description \\\cline{1-6}
\-Header&\-Identifier&1&1&0x01&\-Fixed \\\cline{1-6}
\-Length&\-Size of data field&1&14&0x0\-E&\-Fixed \\\cline{1-6}
\-Data&unused&1&&&\\\cline{1-6}
\end{TabularC}
...
21&\-Controller \-Info&\-P\-I\-D gain values of wheel velocity controller.&\-On request \\\cline{1-4}
\end{TabularC}
...
\-Negative sign indicates backward direction }\\\cline{1-3}\cline{2-6}
...
\-Overcurrent flags&1&&&\-Flag will be setted when overcurrent is detected\par
...
\end{DoxyNote}
\begin{DoxySeeAlso}{\-See also}
\doxyref{\-Appendix \-: \-Kobuki \-Parameters}{p.}{enAppendixKobukiParameters} -\/ necessary parameters for conversion of encoder ticks to robot pose.
\end{DoxySeeAlso}
\par
...
\-This sub-\/payload provides {\tt \-A\-D\-C} data of {\tt \-P\-S\-D} sensor, which is facing the floor.
...
\-Data range\-: 0 $\sim$ 4095 (0 $\sim$ 3.\-3\-V)\par
\-Distance range\-: 2 $\sim$ 15 cm\par
\-Distance is not linear w.\-r.\-t. \-A\-D\-C output.\par
\-See the {\tt datasheet} for more detail. }\\\cline{1-1}\cline{3-6}
...
\-Voltage range\-: 0 $\sim$ 3.\-3 \-V }\\\cline{1-5}\cline{4-6}
...
\end{DoxySeeAlso}
\par
\subsection{\-Controller Info}\label{enAppendixProtocolSpecification_enControllerInfo}
\-Contains \-P\-I\-D gain of wheel velocity controller of robot.

\begin{TabularC}{6}
\hline
&\-Name&\-Size&\-Value&\-Value in \-Hex&\-Description \\\cline{1-6}
\-Header&\-Identifier&1&1&0x01&\-Fixed \\\cline{1-6}
\-Length&\-Size of data field&1&21&0x15&\-Fixed \\\cline{1-6}
\multirow{4}{\linewidth}{\-Data}&\-Type&1&&&\-Current controller setup\par
0 for factory-\/default \-P\-I\-D gain\par
1 for user-\/configured \-P\-I\-D gain \\\cline{1-2}\cline{4-6}
&\-P gain&4&&&\-Kp $\ast$ 1000 (default\-: 100$\ast$1000) \\\cline{1-1}\cline{3-6}
&\-I gain&4&&&\-Ki $\ast$ 1000 (default\-: 0.\-1$\ast$1000) \\\cline{2-6}
&\-D gain&4&&&\-Kd $\ast$ 1000 (default\-: 2$\ast$1000) \\\cline{1-6}
